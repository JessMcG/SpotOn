...
$.ajax({
		...
		success: function(data){
			$(data.tracks).each(function(index, value){
				...
				var appendTrack = "<li class='trackOnProfile playSingleTrack'><p>" + value.artist_name + " - <span>" + value.track_name + " " + "</span></p><div class='playTrackProfile'><img src='img/play.png' alt='" + value.track_id +"' />";
			...
			$(".playSingleTrack").click(function(){
				alert($(".playSingleTrack").attr("img"));
				var c = data.tracks[c].track_id;
